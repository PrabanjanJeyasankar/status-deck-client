import { useDeleteService, useUpdateService } from '@/002-hooks/useServices'
  ...
  return (
    <>
      <Card
        ...
        className='rounded-none borde dark:bg-zinc-950 hover:shadow-lg transition-shadow cursor-pointer p-6 flex flex-col gap-5'>
        {/* Header */}
